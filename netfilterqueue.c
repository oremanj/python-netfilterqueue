 ...
 *     def __str__(self):
 */
  ((struct __pyx_obj_14netfilterqueue_Packet *)__pyx_v_self)->_given_payload = NULL;
...
static PyMethodDef __pyx_methods_14netfilterqueue_Packet[] = {
  ...
  {__Pyx_NAMESTR("set_mark"), (PyCFunction)__pyx_pf_14netfilterqueue_6Packet_5set_mark, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("accept"), (PyCFunction)__pyx_pf_14netfilterqueue_6Packet_6accept, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_14netfilterqueue_6Packet_6accept)},
  {__Pyx_NAMESTR("drop"), (PyCFunction)__pyx_pf_14netfilterqueue_6Packet_7drop, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_14netfilterqueue_6Packet_7drop)},
  {0, 0, 0, 0}
};
